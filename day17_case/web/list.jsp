...
<head>
    ...
    <script>
        ...
        window.onload = function () {
            ...
            document.getElementById("fristId").onclick = function () {
...
<div class="container">
    ...
    <div style="float:left">
        <form class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" name="email"value="${condition.email[0]}" id="exampleInputEmail3" >
            </div>
    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <tr class="success">
            <th><input type="checkbox" id="fristId"></th>
            <th>编号</th>
            <th>姓名</th>
            <th>性别</th>
            <th>年龄</th>
